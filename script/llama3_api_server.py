...
tokenizer = AutoTokenizer.from_pretrained(args.base_model, add_eos_token=True,
                                          padding_side="left", token="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")

print(f"tokenizer success {tokenizer}")
# base_model加载
print(f"Loading the base model from path :  {args.base_model}")
...
TEMPLATE_WITHOUT_SYSTEM_PROMPT = "<s>[INST] {instruction} [/INST]"
...
if __name__ == "__main__":
    ...
    uvicorn.run(app, host="0.0.0.0", port=80, workers=1, log_config=log_config)
